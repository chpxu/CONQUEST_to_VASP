...
class density(processor_base):
    """Process density data in .cube format

    CONQUEST allows plotting charge and band densities, which can be read by software like VESTA.
...
class chden(density):
    ...
    ch1: str,
    ch2: str | None = None,
    mode: Literal["sum", "diff"] | None = None) -> None:
        super().__init__(hkl, offset)
