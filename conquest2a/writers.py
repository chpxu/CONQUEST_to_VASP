...
class xsf_writer_spins(file_writer):
    def __init__(self, dest: Path | str, charges: atom_charge, xsf_file: Path| str, encoding: str = "utf-8"):
        """
    ...
    def process_xsf_file(self) -> None:
        ...
        lines: list[str] = []
        with open(self.xsf_file, mode="r", encoding=self.encoding) as original_xsf:
